        ...
        <div class="container">
          <div class="navbar-header">
            ...
            <ul class="nav navbar-nav ">
                   <button type="button" class="btn btn-info btn-lg" onclick="window.location.href='adminHome.php'">Log In</button>
<!--               <li><a href ="adminHome.php" class="btn btn-info">Log IN  <span class="glyphicon glyphicon-log-in"></span></a></li>            
 -->            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
